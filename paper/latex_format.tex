...
\begin{figure}[t]
   \begin{center}
      \includegraphics[width=1.0\linewidth]{figures/opioidvsnon.png}
   \end{center}
...
\begin{figure}[t]
   \begin{center}
      \includegraphics[width=1.0\linewidth]{figures/predictormodel1.png}
   \end{center}
...
\begin{figure}[t]
   \begin{center}
      \includegraphics[width=1.0\linewidth]{figures/predictormodel2.png}
   \end{center}
